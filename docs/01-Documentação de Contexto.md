...
É inegável que em toda a vida de uma pessoa, novos vínculos com outras pessoas são criados. Por mais isolada que seja, uma pessoa sempre terá um número finito de contatos e, consequentemente, uma série de informações a respeito desses contatos.
...
O objetivo deste projeto é apresentar e desenvolver uma ferramenta que permita catalogar os contatos devidamente, de forma que passe de uma básica agenda telefônica para um software organizacional, tendo o poder de facilitar a busca e manutenção cadastral. 

Propõe-se, então, um sistema onde se possa cadastrar pessoas, categorizá-las devidamente em função das suas capacidades profissionais e permitir a criação de campos avulsos nos seus cadastros. Além disso será oferecido a exportação dos dados para MS-Excel.
